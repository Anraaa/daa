...
# Abaikan Yang Fitur Utama

### Fitur Utama
- **Dashboard Company Profile**
  - Deskripsi: Menampilkan informasi umum tentang perusahaan pada PT. Meowrigin
  - Fitur: CRUD untuk data company profile seperti nama perusahaan, deskripsi
- **Dashboard Control Pada Company Profile**
  Pengelolaan pada admin untuk mengontrol informasi yang ditampilkan di company profile
- **Porsi Latihan Untuk Atlet**
  Sistem untuk membuat dan mengelola program latihan atlet
- **Data Personal Untuk Atlet**
  Menyimpan data pribadi atlet
- **Klasifikasi Penilaian Untuk Atlet**
  Sistem untuk menilai dan mengklasifikasikan atlet berdasarkan peforma atlet
- **Klasemen Atlet Untuk Pertandingan**
  Menentukan daftar atlet yang layak bertanding berdasarkan hasil latihan
- **Manajemen Waktu Untuk Pertandingan**
  Sistem untuk mengatur jadwal pertandingan atlet